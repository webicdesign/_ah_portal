 ...
 * persian date time class
 * no direct access
 */
class _ah_pd
{
	public function current_date(){
		return '13'.(self::jdate('y','','','','en')*10000)+(self::jdate('m','','','','en')*100)+(self::jdate('d','','','','en'));
	}

	public function _ah_day_begore($day){
	...
	public function current_time(){
		return self::jdate('H','','','','en').self::jdate('i','','','','en').self::jdate('s','','','','en');
	}
